<template>
  <div class="min-h-screen">
    ...
    <PartnerPageHeader
      ...
      subtitle="Check the settlement history"
    ...
    <div class="relative z-10 mx-auto px-4 py-6 w-full max-w-[1500px]">
      ...
      <div class="tab-content">
        <SettlementReport v-if="activeTab" :game="activeTab.toUpperCase()" />
      </div>
    </div>
  </div>
</template>
...
import SettlementReport from "@/components/settlement/SettlementReport.vue";

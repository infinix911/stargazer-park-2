<template>
  ...
  <div class="d-flex justify-content-center align-items-center flex-column vh-100" v-else>
    <div class="spinner-border mb-4" role="status"></div>
    <div class="text-xs text-center">게임을 실행하고 있습니다.<br />잠시만 기다려 주세요.</div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const allowedProviders = ["snow", "SNOW_LIVE", "SNOW_SNOW2", "SNOW_SNOW3", "SNOW_SLOT", "SNOW_KSLOT", "KP", "KH", "RAISE", "HONORLINK"];

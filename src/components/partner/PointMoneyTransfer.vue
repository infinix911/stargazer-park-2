        ...
        <form @submit.prevent="handleSubmit" class="space-y-3 sm:space-y-4">
          ...
          <div class="space-y-2">
            <div class="flex items-center space-x-2">
              ...
              <label class="text-white font-medium">{{ t("partner.receiverMember") }}</label>
            </div>
            <Input
          ...
          <div class="space-y-2">
            <div class="flex items-center space-x-2">
              <ArrowUpDown class="w-5 h-5 text-green-400" />
              <label class="text-white font-medium">{{ t("partner.tranType") }}</label>
            </div>
            <Input
          ...
          <div class="space-y-2">
            <div class="flex items-center space-x-2">
              ...
              <label class="text-white font-medium">{{ t("partner.tranAmount") }}</label>
            </div>
            <Input
              v-model="form.amount"
              type="number"
